...
module.exports = {
	...
	notifyUrl: {
		// 测试环境服务空间-支付回调地址
		'mp-ed0e86aa-0996-4d34-9a09-ccff5b894b8f': 'https://fc-mp-ed0e86aa-0996-4d34-9a09-ccff5b894b8f.next.bspapp.com/uni-pay-co',
	...
	wxpay: {
		...
		// 微信 - 小程序支付
		mp: {
			appId: 'wx3f17cf93d3a4823a', // 小程序的appid
			secret: '87aee1b07a2732f6bf3abe0dc159db5f', // 小程序的secret
			mchId: '1725575056', // 商户id
			key: '', // v2的api key
