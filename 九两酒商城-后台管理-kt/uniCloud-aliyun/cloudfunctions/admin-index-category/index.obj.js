  ...
  async twoadd(params = {}) {
    try {
      let {
        ...
        errCode,
        errMsg
      } = await dbJQL.collection("afenleilist").add(params);
  ...
  async twolist() {
    try {
      let {
        errCode,
        data
      } = await dbJQL.collection("afenleilist")
        .field("_id,  name,sort")
  ...
  async twoupdate({
    ...
    try {
      ...
      let {
        ...
        errMsg,
        updated
      } = await dbJQL.collection("afenleilist").doc(_id).update({
        ...rest
      });
      if (errCode !== 0) return result({
        errCode: 400,
  ...
  async tworemove({
    ...
    try {
      ...
      let {
        ...
        errMsg,
        deleted
      } = await dbJQL.collection("afenleilist").doc(_id).remove();
      if (errCode !== 0) return result({
        errCode: 400,
        errMsg: "error",
        custom: errMsg
  ...
  async twodetail({
    ...
    try {
      ...
      let {
        errCode,
        data
      } = await dbJQL.collection("afenleilist").doc(_id)
