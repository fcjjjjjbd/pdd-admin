  ...
  async add(params = {}) {
    try {
      let {
        ...
        errMsg,
        id
      } = await dbJQL.collection("aopen-hotsearch").add(params)
  ...
  async list() {
    try {
      let {
        ...
        count,
        data
      } = await dbJQL.collection("aopen-hotsearch")
        .orderBy("sort asc")
  ...
  async remove({
    ...
    try {
      ...
      let {
        ...
        errMsg,
        deleted
      } = await dbJQL.collection("aopen-hotsearch").doc(_id).remove();
      if (errCode !== 0) return result({
        errCode: 400,
        errMsg: "error",
        custom: errMsg
  ...
  async update({
    ...
    try {
      ...
      let {
        ...
        errMsg,
        updated
      } = await dbJQL.collection("aopen-hotsearch").doc(_id).update(rest);
      if (errCode !== 0) return result({
        errCode: 400,
        errMsg: "error",
        custom: errMsg
