...
<template>
	<view class="uni-container">
		...
		<view class="module" v-if="detail.delivery_type == 0">
			<el-divider content-position="left" border-style="dashed">自提信息</el-divider>
			<el-row>
				<el-col :xl="8" :md="8">
					<view class="row">
						<view class="label">配送方式</view>
						<view class="content">
							<view class="delivery_way a">
				...
				<el-col :xl="8" :md="8">
					<view class="row">
						...
						<view class="content">
							{{ detail?.self_take_info?.merchant_store || '未设置' }}
						</view>
					</view>
				</el-col>
				<el-col :xl="8" :md="8">
					<view class="row">
						...
						<view class="content">
							{{ detail?.self_take_info?.merchant_address }}
						</view>
					</view>
				</el-col>
				...
				<el-col :xl="8" :md="8">
					<view class="row">
						<view class="label">取件人电话</view>
						<view class="content">
							{{ detail?.self_take_info?.user_phone }}
						</view>
					</view>
				</el-col>
				<el-col :xl="16" :md="16">
					<view class="row">
						...
						<view class="content">
							{{ detail?.self_take_info?.user_time }}
						</view>
					</view>
				</el-col>
				<el-col :xl="24" :md="24">
					<view class="row">
						<view class="label">状态修改</view>
						<view class="content">
							<el-button disabled v-if="detail.order_status == -1">已关闭</el-button>
							<el-button v-if="detail.order_status == 2 || detail.order_status == 5" @click="handleConfirm" type="primary" :disabled="detail.order_status == 5">订单完成</el-button>
							<el-button @click="handleRefund" v-if="detail.order_status == 4" type="danger" :disabled="detail.payment_method != 0">处理退款</el-button>
						</view>
					</view>
				</el-col>
			</el-row>
		...
		<view class="module" v-if="detail.delivery_type == 1">
			<el-divider content-position="left" border-style="dashed">配送信息</el-divider>
			<el-row>
				<el-col :xl="8" :md="8">
					<view class="row">
						<view class="label">配送方式</view>
						<view class="content">
							<view class="delivery_way b">
								<template v-if="detail.transport_info.type == 0">
									<el-icon size="16" :color="`#409EFF`"><Bicycle /></el-icon>
									<text>同城</text>
								</template>
								<template v-if="detail.transport_info.type == 1">
				...
				<el-col :xl="8" :md="8">
					<view class="row">
						<view class="label">配送商户ID</view>
						<view class="content">
							{{ detail?.transport_info?.wx_store_id || '-' }}
						</view>
					</view>
				</el-col>
				...
				<el-col :xl="8" :md="8">
					<view class="row">
						...
						<view class="content">￥{{ formatPrice(detail.transport_fee) }}</view>
					</view>
				</el-col>
				...
				<el-col :xl="8" :md="8">
					<view class="row">
						...
						<view class="content">
							{{ detail.transport_info.user_name }}
						</view>
					</view>
				</el-col>
				...
				<el-col :xl="8" :md="8">
					<view class="row">
						<view class="label">收货人电话</view>
						<view class="content">
							{{ detail.transport_info.user_phone }}
						</view>
					</view>
				</el-col>
				...
				<el-col :xl="8" :md="8">
					<view class="row">
						<view class="label">收货人地址</view>
						<view class="content">
							{{ detail.transport_info.user_address }}
						</view>
					</view>
				</el-col>
				...
				<el-col :xl="8" :md="8">
					<view class="row">
						<view class="label">收货人经纬度</view>
						<view class="content">{{ detail.transport_info.user_location.coordinates }}</view>
					</view>
				</el-col>

				<el-col :xl="8" :md="8">
					<view class="row">
						<view class="label">货物信息</view>
						<view class="content">
							{{ detail.transport_info?.cargo }}
						</view>
					</view>
				</el-col>
				...
				<el-col :xl="8" :md="8">
					<view class="row">
						<view class="label">配送单号</view>
						<view class="content">
							{{ detail.transport_info.waybill_id || '-' }}
						</view>
					</view>
				</el-col>
				...
				<el-col :xl="24" :md="24">
					<view class="row">
						...
						<view class="content">
							<el-button disabled v-if="detail.order_status == -1">已关闭</el-button>
							<el-button v-if="detail.order_status == 1" @click="handleSend" type="primary">发货配送</el-button>
							<el-button v-if="detail.order_status == 3 || detail.order_status == 5" @click="handleConfirm" type="primary" :disabled="detail.order_status == 5">订单完成</el-button>
